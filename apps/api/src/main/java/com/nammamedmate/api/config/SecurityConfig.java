        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(HttpMethod.GET, "/api/v1/health")
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/notifications/whatsapp/send")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/notifications/whatsapp/webhook")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/notifications/email/send")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/notifications/email/webhook")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/notifications/email/t/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/notifications/unsubscribe")
                    .permitAll()
                    ...
                    .requestMatchers(
                        HttpMethod.GET, "/api/v1/admin/notifications/whatsapp/templates")
                    .hasRole("ADMIN_SUPER")
                    .requestMatchers(
                        HttpMethod.POST, "/api/v1/admin/notifications/whatsapp/templates")
                    .hasRole("ADMIN_SUPER")
                    .requestMatchers(HttpMethod.GET, "/api/v1/admin/notifications/whatsapp/logs")
                    .hasAnyRole("ADMIN_SUPER", "ADMIN_OPERATIONS")
                    .requestMatchers(HttpMethod.GET, "/api/v1/admin/notifications/email/templates")
                    .hasRole("ADMIN_SUPER")
                    .requestMatchers(HttpMethod.POST, "/api/v1/admin/notifications/email/templates")
                    .hasRole("ADMIN_SUPER")
                    .requestMatchers(HttpMethod.GET, "/api/v1/admin/notifications/email/logs")
                    .hasAnyRole("ADMIN_SUPER", "ADMIN_OPERATIONS")
