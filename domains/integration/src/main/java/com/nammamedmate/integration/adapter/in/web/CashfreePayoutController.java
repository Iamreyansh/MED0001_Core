...
@Tag(name = "CashfreePayout payouts (S2S)")
public class CashfreePayoutController {

  private final CashfreeIntegrationService service;
  private final InternalServiceAuth internalAuth;

  public CashfreePayoutController(
  ...
  @PostMapping("/payout")
  @Operation(summary = "Initiate CashfreePayout payout (internal token)")
