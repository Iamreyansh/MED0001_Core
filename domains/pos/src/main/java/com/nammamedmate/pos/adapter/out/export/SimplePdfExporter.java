...
/** Minimal multi-line PDF writer (no PDF library). Supports A4 and 80mm thermal page boxes. */
public final class SimplePdfExporter {

  public static final int A4_WIDTH = 612;
  public static final int A4_HEIGHT = 792;

  /** ~80mm thermal width at 72dpi. */
  public static final int THERMAL_WIDTH = 226;

  public static final int THERMAL_HEIGHT = 800;

  private SimplePdfExporter() {}

  public static byte[] export(String title, List<String> lines, boolean thermal) {
    ...
    int width = thermal ? THERMAL_WIDTH : A4_WIDTH;
    int height = thermal ? THERMAL_HEIGHT : A4_HEIGHT;
    int fontSize = thermal ? 8 : 10;
    int marginX = thermal ? 10 : 40;
    int startY = thermal ? height - 20 : 750;
    return buildPdf(content, width, height, fontSize, marginX, startY);
  }
  ...
  public static byte[] buildPdf(String text) {
    ...
    return export(null, lines, false);
  }
