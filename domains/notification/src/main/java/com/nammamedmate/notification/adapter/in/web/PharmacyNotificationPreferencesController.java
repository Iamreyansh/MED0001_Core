...
@RestController
@RequestMapping("/api/v1/pharmacy/notification-preferences")
@Tag(name = "Pharmacy notification preferences")
public class PharmacyNotificationPreferencesController {

  private final PreferenceService preferences;

  public PharmacyNotificationPreferencesController(PreferenceService preferences) {
    this.preferences = preferences;
  }

  @GetMapping
  @Operation(summary = "Get pharmacy notification preferences")
  public ApiResponse<Map<String, Object>> get(@AuthenticationPrincipal MedmatePrincipal principal) {
    return ApiResponse.ok(preferences.getPharmacyPreferences(principal));
  }

  @PatchMapping
  @Operation(summary = "Update pharmacy notification preferences (owner only)")
  public ApiResponse<Map<String, Object>> patch(
    ...
    return ApiResponse.ok(
        preferences.patchPharmacyPreferences(principal, req.channels(), req.categories()));
  }
